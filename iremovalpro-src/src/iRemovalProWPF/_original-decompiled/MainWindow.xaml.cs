...
namespace iRemovalProWPF
{
    ...
    public partial class MainWindow : Window
    {
        ...
        {
            // Intentar cargar iremovalpro.dll para saber si esta disponible.
            // Si no esta, los handlers van a tirar DllNotFoundException.
            try
            {
        ...
        private void MainWindow_Loaded(object sender, RoutedEventArgs e)
        {
            ...
            try
            {
                // Registrar el callback para que el engine pueda drivear la UI.
                // Mantener viva la referencia (_callback) para que el GC no la recolecte
                // mientras el código nativo la tenga enganchada.
        ...
        /// <summary>
        /// Callback invocado por el engine nativo para actualizar la UI.
        /// (action, key, value) — la firma original recoverada de Library.cs.
        /// Sin dump dinamico del engine no sabemos que action codes hace que,
        /// asi que por ahora solo logeamos.
        /// </summary>
        private void OnEngineCallback(int action, string key, string value)
        {
            // Los callbacks vienen de un hilo nativo — despachar al UI thread.
        ...
        /// <summary>
        /// Click en el boton checkra1n (principal) — originalmente llamaba a Library.Action(9).
        /// </summary>
        ...
        /// <summary>
        /// Click en label Serial Number — originalmente llamaba a Library.Action(5).
        /// </summary>
        ...
        /// <summary>
        /// Click en label IMEI — originalmente llamaba a Library.Action(6).
        /// </summary>
